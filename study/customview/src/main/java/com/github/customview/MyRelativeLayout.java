...
public class MyRelativeLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs){
        ...
        allLine = viewNormal.getBoolean(R.styleable.MyRelativeLayout_my_rl_all_line, false);
        leftLine = viewNormal.getBoolean(R.styleable.MyRelativeLayout_my_rl_left_line, false);
        topLine = viewNormal.getBoolean(R.styleable.MyRelativeLayout_my_rl_top_line,false);
        rightLine = viewNormal.getBoolean(R.styleable.MyRelativeLayout_my_rl_right_line,false);
        bottomLine = viewNormal.getBoolean(R.styleable.MyRelativeLayout_my_rl_bottom_line, false);
        borderWidth = viewNormal.getDimension(R.styleable.MyRelativeLayout_my_rl_border_width, 0);
        solidColor = viewNormal.getColor(R.styleable.MyRelativeLayout_my_rl_solid, getDefColor());
        pressColor = viewNormal.getColor(R.styleable.MyRelativeLayout_my_rl_press, getDefColor());
        borderColor = viewNormal.getColor(R.styleable.MyRelativeLayout_my_rl_border_color, getDefColor());
        dashWidth = viewNormal.getDimension(R.styleable.MyRelativeLayout_my_rl_border_dashWidth, 0);
        dashGap = viewNormal.getDimension(R.styleable.MyRelativeLayout_my_rl_border_dashGap, 0);
        radius = viewNormal.getDimension(R.styleable.MyRelativeLayout_my_rl_corner_radius, 0);
        if(radius<=0){
            topLeftRadius = viewNormal.getDimension(R.styleable.MyRelativeLayout_my_rl_corner_topLeftRadius, 0);
            topRightRadius = viewNormal.getDimension(R.styleable.MyRelativeLayout_my_rl_corner_topRightRadius, 0);
            bottomLeftRadius = viewNormal.getDimension(R.styleable.MyRelativeLayout_my_rl_corner_bottomLeftRadius, 0);
            bottomRightRadius = viewNormal.getDimension(R.styleable.MyRelativeLayout_my_rl_corner_bottomRightRadius, 0);
        }
        complete();
        viewNormal.recycle();
    }
