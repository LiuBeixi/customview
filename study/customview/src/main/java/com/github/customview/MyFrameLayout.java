...
public class MyFrameLayout extends FrameLayout {
    ...
    private void init(AttributeSet attrs){
        ...
        allLine = viewNormal.getBoolean(R.styleable.MyFrameLayout_my_fl_all_line, false);
        leftLine = viewNormal.getBoolean(R.styleable.MyFrameLayout_my_fl_left_line, false);
        topLine = viewNormal.getBoolean(R.styleable.MyFrameLayout_my_fl_top_line,false);
        rightLine = viewNormal.getBoolean(R.styleable.MyFrameLayout_my_fl_right_line,false);
        bottomLine = viewNormal.getBoolean(R.styleable.MyFrameLayout_my_fl_bottom_line, false);
        borderWidth = viewNormal.getDimension(R.styleable.MyFrameLayout_my_fl_border_width, 0);
        solidColor = viewNormal.getColor(R.styleable.MyFrameLayout_my_fl_solid, getDefColor());
        pressColor = viewNormal.getColor(R.styleable.MyFrameLayout_my_fl_press, getDefColor());
        borderColor = viewNormal.getColor(R.styleable.MyFrameLayout_my_fl_border_color, getDefColor());
        dashWidth = viewNormal.getDimension(R.styleable.MyFrameLayout_my_fl_border_dashWidth, 0);
        dashGap = viewNormal.getDimension(R.styleable.MyFrameLayout_my_fl_border_dashGap, 0);
        radius = viewNormal.getDimension(R.styleable.MyFrameLayout_my_fl_corner_radius, 0);
        if(radius<=0){
            topLeftRadius = viewNormal.getDimension(R.styleable.MyFrameLayout_my_fl_corner_topLeftRadius, 0);
            topRightRadius = viewNormal.getDimension(R.styleable.MyFrameLayout_my_fl_corner_topRightRadius, 0);
            bottomLeftRadius = viewNormal.getDimension(R.styleable.MyFrameLayout_my_fl_corner_bottomLeftRadius, 0);
            bottomRightRadius = viewNormal.getDimension(R.styleable.MyFrameLayout_my_fl_corner_bottomRightRadius, 0);
        }
        complete();
        viewNormal.recycle();
    }
