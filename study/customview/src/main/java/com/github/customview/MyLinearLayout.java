...
public class MyLinearLayout extends LinearLayout {
    ...
    private void init(AttributeSet attrs){
        ...
        allLine = viewNormal.getBoolean(R.styleable.MyLinearLayout_my_ll_all_line, false);
        leftLine = viewNormal.getBoolean(R.styleable.MyLinearLayout_my_ll_left_line, false);
        topLine = viewNormal.getBoolean(R.styleable.MyLinearLayout_my_ll_top_line,false);
        rightLine = viewNormal.getBoolean(R.styleable.MyLinearLayout_my_ll_right_line,false);
        bottomLine = viewNormal.getBoolean(R.styleable.MyLinearLayout_my_ll_bottom_line, false);
        borderWidth = viewNormal.getDimension(R.styleable.MyLinearLayout_my_ll_border_width, 0);
        solidColor = viewNormal.getColor(R.styleable.MyLinearLayout_my_ll_solid, getDefColor());
        pressColor = viewNormal.getColor(R.styleable.MyLinearLayout_my_ll_press, getDefColor());
        borderColor = viewNormal.getColor(R.styleable.MyLinearLayout_my_ll_border_color, getDefColor());
        dashWidth = viewNormal.getDimension(R.styleable.MyLinearLayout_my_ll_border_dashWidth, 0);
        dashGap = viewNormal.getDimension(R.styleable.MyLinearLayout_my_ll_border_dashGap, 0);
        radius = viewNormal.getDimension(R.styleable.MyLinearLayout_my_ll_corner_radius, 0);
        if(radius<=0){
            topLeftRadius = viewNormal.getDimension(R.styleable.MyLinearLayout_my_ll_corner_topLeftRadius, 0);
            topRightRadius = viewNormal.getDimension(R.styleable.MyLinearLayout_my_ll_corner_topRightRadius, 0);
            bottomLeftRadius = viewNormal.getDimension(R.styleable.MyLinearLayout_my_ll_corner_bottomLeftRadius, 0);
            bottomRightRadius = viewNormal.getDimension(R.styleable.MyLinearLayout_my_ll_corner_bottomRightRadius, 0);
        }
        complete();
        viewNormal.recycle();
    }
