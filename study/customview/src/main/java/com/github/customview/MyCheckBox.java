...
public class MyCheckBox extends CheckBox {
    ...
    private void init(AttributeSet attrs){
        ...
        my_normal = viewNormal.getDrawable(R.styleable.MyCheckBox_my_checkbox_normal);
        my_checked = viewNormal.getDrawable(R.styleable.MyCheckBox_my_checkbox_checked);
        my_normal_color = viewNormal.getColor(R.styleable.MyCheckBox_my_checkbox_normal_color, this.getTextColors().getDefaultColor());
        my_checked_color = viewNormal.getColor(R.styleable.MyCheckBox_my_checkbox_checked_color,-1);
        my_checked_drawable = viewNormal.getInteger(R.styleable.MyCheckBox_my_checkbox_checked_drawable, 0);
        viewNormal.recycle();
        complete();
    }
