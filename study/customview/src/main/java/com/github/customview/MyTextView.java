...
public class MyTextView extends TextView {
    ...
    private void init(AttributeSet attrs){
        ...
        boolean allLine=viewNormal.getBoolean(R.styleable.MyTextView_my_tv_all_line, false);
        ...
        int solidColor = viewNormal.getColor(R.styleable.MyTextView_my_tv_solid, getDefColor());
        int pressColor = viewNormal.getColor(R.styleable.MyTextView_my_tv_press, getDefColor());
        int borderColor = viewNormal.getColor(R.styleable.MyTextView_my_tv_border_color, getDefColor());
        ...
        if(lineFlag&&!allLine){//layer-list
            ...
            layerDrawable.setLayerInset(1, lineType[0], lineType[1], lineType[2], lineType[3]);//第一层的偏移量
